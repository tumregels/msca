...
dpath = '/../../Dragon/2L/ASSBLY_B/output_2020-09-05_12-50-03/';
spath = '/../../Serpent/ASSBLY_B/output_2020-08-23_12-19-31/';

s(1).drag_filename = fullfile(filedir, dpath, 'ASSBLY_CASEB_R_BCOND2.txt');
s(1).serp_filename = fullfile(filedir, spath, 'ASSBLY_CASEB_mc_det0.m');
s(1).serp_dep_filename = fullfile(filedir, spath, 'ASSBLY_CASEB_mc_dep.m');
s(1).results_fission = fullfile(filedir, dpath, 'process_bfm_first.result');
s(1).results_capture = fullfile(filedir, dpath, 'process_bcm_first.result');

s(2).drag_filename = fullfile(filedir, dpath, 'ASSBLY_CASEB_R_BCOND2_PEAK.txt');
s(2).serp_filename = fullfile(filedir, spath, 'ASSBLY_CASEB_mc_det52.m');
s(2).serp_dep_filename = fullfile(filedir, spath, 'ASSBLY_CASEB_mc_dep.m');
s(2).results_fission = fullfile(filedir, dpath, 'process_bfm_peak.result');
s(2).results_capture = fullfile(filedir, dpath, 'process_bcm_peak.result');

s(3).drag_filename = fullfile(filedir, dpath, 'ASSBLY_CASEB_R_BCOND2_LAST.txt');
s(3).serp_filename = fullfile(filedir, spath, 'ASSBLY_CASEB_mc_det107.m');
s(3).serp_dep_filename = fullfile(filedir, spath, 'ASSBLY_CASEB_mc_dep.m');
s(3).results_fission = fullfile(filedir, dpath, 'process_bfm_last.result');
s(3).results_capture = fullfile(filedir, dpath, 'process_bcm_last.result');
...
hname = { ...
    ...
    'DET_C0301_A', 'DET_C0301_B', 'DET_C0301_C', 'DET_C0301_D', ...
    ...
    'DET_C0505_A', 'DET_C0505_B', 'DET_C0505_C', 'DET_C0505_D', ...
    'DET_C0601_A', 'DET_C0601_B', 'DET_C0601_C', 'DET_C0601_D', ...
    'DET_C0602_A', 'DET_C0602_B', 'DET_C0602_C', 'DET_C0602_D', ...
    'DET_C0603_A', 'DET_C0603_B', 'DET_C0603_C', 'DET_C0603_D', 'DET_C0603_E', 'DET_C0603_F', ...
    ...
    'DET_C0707_A', 'DET_C0707_B', 'DET_C0707_C', 'DET_C0707_D', ...
    ...
    'DET_C0804_A', 'DET_C0804_B', 'DET_C0804_C', 'DET_C0804_D', ...
...
for i = 1:numel(s)
    ...
    mat_filename = fullfile(filedir, '..', '..', 'data', sprintf('parse_dragon_b_2l_%02d.mat', i));
