...
dpath = '/../../Dragon/1L/ASSBLY_A/output_2020-09-05_12-32-26/';
spath = '/../../Serpent/ASSBLY_A/output_2020-09-08_10-03-02/';

s(1).drag_filename = fullfile(filedir, dpath, 'ASSBLY_CASEA_R_BCOND2.txt');
s(1).serp_filename = fullfile(filedir, spath, 'ASSBLY_CASEA_mc_det0.m');
s(1).serp_dep_filename = fullfile(filedir, spath, 'ASSBLY_CASEA_mc_dep.m');
s(1).results_fission = fullfile(filedir, dpath, 'process_afm_first.result');
s(1).results_capture = fullfile(filedir, dpath, 'process_acm_first.result');

s(2).drag_filename = fullfile(filedir, dpath, 'ASSBLY_CASEA_R_BCOND2_LAST.txt');
s(2).serp_filename = fullfile(filedir, spath, 'ASSBLY_CASEA_mc_det59.m');
s(2).serp_dep_filename = fullfile(filedir, spath, 'ASSBLY_CASEA_mc_dep.m');
s(2).results_fission = fullfile(filedir, dpath, 'process_afm_last.result');
s(2).results_capture = fullfile(filedir, dpath, 'process_acm_last.result');
...
for i = 1:numel(s)
    ...
    mat_filename = fullfile(filedir, '..', '..', 'data', sprintf('parse_dragon_a_1l_%02d.mat', i));
